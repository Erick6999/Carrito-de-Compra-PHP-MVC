<header class="pt-36 pt-16 xl:pt-20 2xl:pt-24">
    ...
    >
          ...
          <li class="mr-3">
            <a
              class="
                ...
                hover:translate-y-1
              "
              href="<?php echo URLROOT; ?>/Sneakers"
              @click="isOpen = false"
              >PRODUCTOS
            </a>
          </li>
          <li class="mr-3">
            <a
              class="
                ...
                hover:translate-y-1
              "
              href="<?php echo URLROOT; ?>/Sneakers/ofertas"
              @click="isOpen = false"
              >OFERTAS
            </a>
          </li>
      ...
      <!-- FAVORITOS (WISH LIST) -->
      <button class="whis-list" onclick="location.href='<?php echo URLROOT; ?>/wishlists/index'">
        <svg 
      ...
      <!-- CARRITO (CART) -->
      <button type="submit" onclick="location.href='<?php echo URLROOT; ?>/shoppings/index'">
      <svg
